...
<body>
			...
			<nav class="top-menu-bar row line-height-0">
				...
				<ul class="row cell-right">
					<li class="cell menu-4"><a href="Custom">고객지원</a>
						...
						<c:if test="${sessionId != null }">
							<li class="cell menu-5"><a href="/member/signup1">마이페이지</a>								<ul>
								<ul>
									<li><a href="#" class="delay-1">회원가입</a></li>
									<li><a href="#" class="delay-2">이용 약관</a></li>
								</ul>
	...
	<form action="">
		<div id="container">
			...
			<fieldset>
				<legend>간편가입</legend>
				<label for="lang">지역</label> <select name="languages" id="lang">
				...
				<br> <input type="date" class="info" placeholder="생년월일 8자리">
				<br>
				<p>
					<b>성별</b>
				</p>
				<div class="radio-container">
					<label for="male"><input type="radio" id="male" name="gen"
						value="남">남</label> <label for="female"><input
				...
				<div id="buttons">
					<br>
					<br> <input type="submit" value="가입하기" id="user_submit">
				</div>
			</fieldset>
		</div>
	</form>
